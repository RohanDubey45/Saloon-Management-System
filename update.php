...
$query = "SELECT * FROM registrations where id ='$a' ";
        ...
        <div class="col-md-6">
            <form id="appointment-form" action="#" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" pattern="[A-Za-z ]+" value="<?php echo $result['name']; ?>" placeholder="Name" required>
                </div>
                <div class="form-group">
    ...
    if(isset($_POST['update'])) 
        {
            ...
            $query = "UPDATE registrations set state='$state',name='$name',email='$email',
            number='$number',city='$city',service='$service',appointment_date='$date' where id='$a'";
